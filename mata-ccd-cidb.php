...
<body>
    ...
    <main class="container">
            ...
            <div class="layout-container">
                ...
                <div class="left-content">
                    <div class="main-title">
                        <h1>Kelebihan Program Pembangunan Kontraktor Secara Berterusan</h1>
                    </div>
                ...
                <div class="right-content">
                    <div class="image-card" data-section="01">
                        ...
                        <div class="image-caption">
                            <h4>Peningkatan Ilmu Pengetahuan</h4>
                            <p>Kepakaran dan profesionalisme kontraktor</p>
                        </div>
                    </div>
                    ...
                    <div class="image-card" data-section="02">
                        ...
                        <div class="image-caption">
                            <h4>Kecekapan Pengurusan</h4>
                            <p>Aspek pengurusan projek pembinaan</p>
                        </div>
                    </div>
                    ...
                    <div class="image-card" data-section="03">
                        ...
                        <div class="image-caption">
                            <h4>Networking & Perkongsian</h4>
                            <p>Interaksi dan perkongsian pengalaman</p>
                        </div>
                    </div>
                    ...
                    <div class="image-card" data-section="04">
                        ...
                        <div class="image-caption">
                            <h4>Kepercayaan Orang Awam</h4>
                            <p>Perkhidmatan kontraktor tempatan</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="ccd-info fade-in">
            <h2 class="ccd-title">Mata CCD CIDB - Apa Itu Mata CCD?</h2>
            <div class="ccd-grid">
                <div class="ccd-item">
        ...
        <section class="content-section fade-in">
            <div class="section-card">
                <h2 class="section-title">Penguatkuasaan Pengumpulan Mata CCD</h2>
                <div class="section-content">
                    <p><strong>Penguatkuasaan Mata CCD</strong> bagi tujuan pembaharuan perakuan pendaftaran telah dikuatkuasakan pada <strong>1 Januari 2010</strong>. Kontraktor yang gagal mengumpul jumlah mata CCD akan menyebabkan perakuan pendaftaran mereka tidak akan diperbaharui atau gred pendaftaran mereka akan diturunkan.</p>

                    <p style="margin-top: 1.5rem;">Kontraktor perlu mengemukakan dokumen sokongan seperti sijil, surat sokongan atau lain-lain sebagai bukti mata CCD yang telah dikumpul semasa mengemukakan permohonan untuk pembaharuan perakuan pendaftaran kontraktor.</p>
                </div>
            </div>
        </section>
